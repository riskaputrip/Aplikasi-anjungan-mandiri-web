                ...
                <div class="col-lg-5 mb-4">
                    <div class="px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
                        ...
                        <div class="d-flex align-items-center me-md-auto">
                            ...
                            <h1 class="h5 pt-2">Data Diri Pasien</h1>
                        </div>
                    </div>
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center d-grid p-6">
                            <?php foreach ($query as $data) : ?>
                                ...
                                <a id="insert" href="/console_box/nomor_antrian/<?= $data['id_pasien']; ?>/<?= $poli; ?>" class="btn btn-primary btn-block rounded-pill fs-5 px-5 py-4 mb-2">
