...
<body class="d-flex flex-column h-100">
        ...
        <div class="container pt-4">
            <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
                ...
                <div class="d-flex align-items-center me-md-auto">
                    ...
                    <h1 class="h5 pt-2">Panggilan Antrian Poli Persalinan</h1>
                </div>
                <!-- breadcrumbs -->
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div>
                                    <p id="antrian-sekarang" class="fs-3 text-success mb-1"><?= isset($antrian_sekarang['no_antrian']) ? $antrian_sekarang['no_antrian'] : ''; ?></p>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div>
                                    <p id="antrian-selanjutnya" class="fs-3 text-info mb-1"><?= isset($antrian_selanjutnya['no_antrian']) ? $antrian_selanjutnya['no_antrian'] : ''; ?></p>
    ...
    <audio id="tingtung" src="<?= base_url('audio/tingtung.mp3'); ?>"></audio>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            jumlah_antrian = $('#jumlah-antrian').text()
            antrian_sekarang = $('#antrian-sekarang').text()
            antrian_selanjutnya = $('#antrian-selanjutnya').text()
            ...
            var table = $('#tabel-antrian').DataTable({
                ...
                ajax: {
                    url: "<?= base_url('/petugas_panggil/antrian_poli_persalinan'); ?>",
                    dataSrc: ''
            ...
            $('#tabel-antrian tbody').on('click', 'button', function() {
                ...
                $('#antrian-sekarang').text(no_antrian)
                ...
                $.ajax({
                    ...
                    url: "<?= base_url('/petugas_panggil/update'); ?>", // url file proses update data
